...
function pg(l,p,ti,d,b){const a=x=>"/"+x+p.slice(3);return `<!DOCTYPE html><html lang="${l}"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${ti}</title><meta name="description" content="${d}"><link rel="canonical" href="${S}${p}"><link rel="alternate" hreflang="en" href="${S}${a("en")}"><link rel="alternate" hreflang="es" href="${S}${a("es")}"><link rel="alternate" hreflang="x-default" href="${S}${a("en")}"><link rel="stylesheet" href="/assets/styles.css"><script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-7258246047135897" crossorigin="anonymous"></script></head><body>${hd(l,p)}<main>${b}</main>${ft(l)}<script src="/assets/app.js"></script></body></html>`}
...
W("dist/index.html",'<!DOCTYPE html><meta charset="utf-8"><script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-7258246047135897" crossorigin="anonymous"></script><script>location.replace((navigator.language||"en").indexOf("es")===0?"/es/":"/en/")</script>');
W("dist/ads.txt","google.com, pub-7258246047135897, DIRECT, f08c47fec0942fa0");
